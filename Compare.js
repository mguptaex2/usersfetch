(function (factory) {
    ...
    var Compare = /** @class */ (function () {
        ...
        Compare.prototype.SortByName = function (first_person_name, second_person_name) {
        ...
        Compare.prototype.SortByAge = function (first_person_age, seconde_person_age) {
            if (first_person_age.age.Years != seconde_person_age.age.Years) {
                console.log(1);
                if (first_person_age.age.Years > seconde_person_age.age.Years)
                    return 1;
                else if (first_person_age.age.Years < seconde_person_age.age.Years)
                    return -1;
            }
            else if (first_person_age.age.Months != seconde_person_age.age.Months) {
                console.log(2);
                if (first_person_age.age.Months > seconde_person_age.age.Months)
                    return 1;
                else if (first_person_age.age.Months < seconde_person_age.age.Months)
                    return -1;
            }
                ...
                console.log(3);
                if (first_person_age.age.Days > seconde_person_age.age.Days)
                    return 1;
                else if (first_person_age.age.Days < seconde_person_age.age.Days)
                    return -1;
            }
        ...
        Compare.prototype.SortByExperience = function (first_person_exp, second_person_exp) {
            console.log(10);
            if (first_person_exp.currentCompanyExp.Years != second_person_exp.currentCompanyExp.Years) {
                console.log(1);
                if (first_person_exp.currentCompanyExp.Years > second_person_exp.currentCompanyExp.Years)
                    return 1;
                else if (first_person_exp.currentCompanyExp.Years < second_person_exp.currentCompanyExp.Years)
                    return -1;
            }
            else if (first_person_exp.currentCompanyExp.Months != second_person_exp.currentCompanyExp.Months) {
                if (first_person_exp.currentCompanyExp.Months > second_person_exp.currentCompanyExp.Months)
                    return 1;
                else if (first_person_exp.currentCompanyExp.Months < second_person_exp.currentCompanyExp.Months)
                    return -1;
            }
